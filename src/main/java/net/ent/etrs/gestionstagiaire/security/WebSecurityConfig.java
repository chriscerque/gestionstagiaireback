...
//    @Getter
    ...
    public WebSecurityConfig(JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint, MyUserDetailService userDetailsService, JwtRequestFilter jwtRequestFilter) {
